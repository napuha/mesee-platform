...
foreach ($method in @('recordImpression','blockUser','fetchUserSettings','updateUserSettings','updateTheme','createLivePost','fetchCreatorAnalytics','fetchProfileStats','requestAccountDeletion','cancelAccountDeletion')) {

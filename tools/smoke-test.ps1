...
foreach ($method in @('recordImpression','blockUser','fetchUserSettings','updateUserSettings','updateTheme','createLivePost','fetchCreatorAnalytics','fetchProfileStats','fetchAdminReports','adminDeletePost','requestAccountDeletion','cancelAccountDeletion')) {
...
if ($migrations.Count -lt 17) { throw 'Expected core migrations 001 through 017.' }
